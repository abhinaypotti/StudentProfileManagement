      ...
      <div class="form-body">
        ...
        <div class="horizontal-group">
          <div class="form-group left">
            <label for="coursename" class="label-title">Course Name</label>
            <input type="text" required id="coursename" name="coursename" class="form-input" placeholder="Enter course name"  />
          </div>
          <div class="form-group right">
            <label for="code" class="label-title">Course code</label>
            <input type="text" required id="code" name="code" class="form-input" placeholder="Enter course code" />
          </div>

          <div class="form-group left">
            <label class="label-title">Branch</label>
            <select required class="form-input" name="branch" id="branch" >
          ...
          <div class="form-group right">
            ...
            <div class="input-group">
              <label for="btech"><input required type="radio" name="degree" value="btech" id="btech"> B.Tech</label>
...
<input type="hidden" name="command" value="ADDCOURSEDATA">
      <!-- form-footer -->
